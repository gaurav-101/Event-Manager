...
const {postEvent,getAllEvents,getEvent,getParticipants,register,checkRegistered} =require('../controller/eventController');
const {authenticator} = require('../controller/userController');

//routes post event
router.post('/event_post',authenticator, postEvent);
//get list of event
